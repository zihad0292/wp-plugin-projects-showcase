            ...
            <div class="row flex-xl-nowrap">
                <div class="col-sm-12 col-md-3 col-lg-2">
                    <div class="sidebar-row mb-3">
                        <h4 class="fs-6 mt-0 mb-3 pb-0 text-dark">Categories:</h4>
                        <div id="filter-buttons">
                            ...
                            if ( have_posts() ){
                                ...
                                echo '<p class="fs-6 ps-3 text-dark">No options available!</p>';
                            }
                            ?>    
                        </div><!-- #filter-buttons -->
                    </div><!-- sidebar-row -->
                    <div class="sidebar-row mb-5">
                        <h4 class="fs-6 mt-0 mb-3 pb-0 text-dark">Sort By:</h4>
                        <?php
                        // check if there are any projects available
                        if ( have_posts() ){ ?>
                        <div id="sort-buttons">
                ...
                <div class="col-sm-12 col-md-9 col-lg-10">
                    <div class="wppool-grid-container">
                        ...
                        <?php else: ?>
                            <p class="text-center fs-5 text-dark">No projects found!</p>
                        <?php endif; ?>
